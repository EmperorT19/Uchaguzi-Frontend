      ...
      <div class="min-h-screen p-8">
        <div class="max-w-7xl mx-auto">
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div *ngFor="let seat of seats"
                 [ngClass]="{
                   'bg-gradient-to-br from-green-600/90 to-green-800/90 border-green-400/30': hasVoted(seat.seat_type),
                   'bg-gradient-to-br from-gray-800/90 to-black/90 border-white/20': !hasVoted(seat.seat_type)
                 }"
...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    // Refresh voted status from backend
