...
export class RegistrationComponent implements OnInit {
  ...
  constituencies = signal<any[]>([
    ...
    { id: 3, name: 'Kisauni', countyId: 1 }, { id: 4, name: 'Nyali', countyId: 1 },
    { id: 5, name: 'Likoni', countyId: 1 }, { id: 6, name: 'Mvita', countyId: 1 },
    { id: 7, name: 'Msambweni', countyId: 2 }, { id: 8, name: 'Lunga Lunga', countyId: 2 },
    { id: 9, name: 'Matuga', countyId: 2 }, { id: 10, name: 'Kinango', countyId: 2 },
    { id: 11, name: 'Kilifi North', countyId: 3 }, { id: 12, name: 'Kilifi South', countyId: 3 },
    { id: 13, name: 'Kaloleni', countyId: 3 }, { id: 14, name: 'Rabai', countyId: 3 },
    { id: 15, name: 'Ganze', countyId: 3 }, { id: 16, name: 'Malindi', countyId: 3 },
    { id: 17, name: 'Magarini', countyId: 3 }, { id: 18, name: 'Garsen', countyId: 4 },
    ...
    { id: 29, name: 'Lagdera', countyId: 7 }, { id: 30, name: 'Dadaab', countyId: 7 },
    { id: 31, name: 'Fafi', countyId: 7 }, { id: 32, name: 'Ijara', countyId: 7 },
    { id: 33, name: 'Wajir North', countyId: 8 }, { id: 34, name: 'Wajir East', countyId: 8 },
    { id: 35, name: 'Tarbaj', countyId: 8 }, { id: 36, name: 'Wajir West', countyId: 8 },
    { id: 37, name: 'Eldas', countyId: 8 }, { id: 38, name: 'Wajir South', countyId: 8 },
    ...
    { id: 45, name: 'Moyale', countyId: 10 }, { id: 46, name: 'North Horr', countyId: 10 },
    { id: 47, name: 'Saku', countyId: 10 }, { id: 48, name: 'Laisamis', countyId: 10 },
    { id: 49, name: 'Isiolo North', countyId: 11 }, { id: 50, name: 'Isiolo South', countyId: 11 },
    { id: 51, name: 'Igembe South', countyId: 12 }, { id: 52, name: 'Igembe Central', countyId: 12 },
    { id: 53, name: 'Igembe North', countyId: 12 }, { id: 54, name: 'Tigania West', countyId: 12 },
    { id: 55, name: 'Tigania East', countyId: 12 }, { id: 56, name: 'North Imenti', countyId: 12 },
    { id: 57, name: 'Buuri', countyId: 12 }, { id: 58, name: 'Central Imenti', countyId: 12 },
    { id: 59, name: 'South Imenti', countyId: 12 }, { id: 60, name: 'Maara', countyId: 13 },
    { id: 61, name: "Chuka/Igambang'ombe", countyId: 13 }, { id: 62, name: 'Tharaka', countyId: 13 },
    { id: 63, name: 'Manyatta', countyId: 14 }, { id: 64, name: 'Runyenjes', countyId: 14 },
    { id: 65, name: 'Mbeere South', countyId: 14 }, { id: 66, name: 'Mbeere North', countyId: 14 },
    { id: 67, name: 'Mwingi North', countyId: 15 }, { id: 68, name: 'Mwingi West', countyId: 15 },
    { id: 69, name: 'Mwingi Central', countyId: 15 }, { id: 70, name: 'Kitui West', countyId: 15 },
    { id: 71, name: 'Kitui Rural', countyId: 15 }, { id: 72, name: 'Kitui Central', countyId: 15 },
    { id: 73, name: 'Kitui East', countyId: 15 }, { id: 74, name: 'Kitui South', countyId: 15 },
    { id: 75, name: 'Masinga', countyId: 16 }, { id: 76, name: 'Yatta', countyId: 16 },
    { id: 77, name: 'Kangundo', countyId: 16 }, { id: 78, name: 'Matungulu', countyId: 16 },
    { id: 79, name: 'Kathiani', countyId: 16 }, { id: 80, name: 'Mavoko', countyId: 16 },
    { id: 81, name: 'Machakos Town', countyId: 16 }, { id: 82, name: 'Mwala', countyId: 16 },
    { id: 83, name: 'Mbooni', countyId: 17 }, { id: 84, name: 'Kilome', countyId: 17 },
    { id: 85, name: 'Kaiti', countyId: 17 }, { id: 86, name: 'Makueni', countyId: 17 },
    ...
    { id: 91, name: 'Ol Kalou', countyId: 18 }, { id: 92, name: 'Ol Jorok', countyId: 18 },
    { id: 93, name: 'Tetu', countyId: 19 }, { id: 94, name: 'Kieni', countyId: 19 },
    { id: 95, name: 'Mathira', countyId: 19 }, { id: 96, name: 'Othaya', countyId: 19 },
    { id: 97, name: 'Mukurweini', countyId: 19 }, { id: 98, name: 'Nyeri Town', countyId: 19 },
    { id: 99, name: 'Mwea', countyId: 20 }, { id: 100, name: 'Gichugu', countyId: 20 },
    { id: 101, name: 'Ndia', countyId: 20 }, { id: 102, name: 'Kirinyaga Central', countyId: 20 },
    { id: 103, name: 'Kangema', countyId: 21 }, { id: 104, name: 'Mathioya', countyId: 21 },
    { id: 105, name: 'Kiharu', countyId: 21 }, { id: 106, name: 'Kigumo', countyId: 21 },
    { id: 107, name: 'Maragwa', countyId: 21 }, { id: 108, name: 'Kandara', countyId: 21 },
    { id: 109, name: 'Gatundu South', countyId: 22 }, { id: 110, name: 'Gatundu North', countyId: 22 },
    { id: 111, name: 'Juja', countyId: 22 }, { id: 112, name: 'Thika Town', countyId: 22 },
    { id: 113, name: 'Ruiru', countyId: 22 }, { id: 114, name: 'Githunguri', countyId: 22 },
    { id: 115, name: 'Kiambu', countyId: 22 }, { id: 116, name: 'Kiambaa', countyId: 22 },
    { id: 117, name: 'Kabete', countyId: 22 }, { id: 118, name: 'Kikuyu', countyId: 22 },
    { id: 119, name: 'Limuru', countyId: 22 }, { id: 120, name: 'Lari', countyId: 22 },
    { id: 121, name: 'Turkana North', countyId: 23 }, { id: 122, name: 'Turkana West', countyId: 23 },
    { id: 123, name: 'Turkana Central', countyId: 23 }, { id: 124, name: 'Loima', countyId: 23 },
    { id: 125, name: 'Turkana South', countyId: 23 }, { id: 126, name: 'Turkana East', countyId: 23 },
    { id: 127, name: 'Kapenguria', countyId: 24 }, { id: 128, name: 'Sigor', countyId: 24 },
    { id: 129, name: 'Kacheliba', countyId: 24 }, { id: 130, name: 'Pokot South', countyId: 24 },
    { id: 131, name: 'Samburu West', countyId: 25 }, { id: 132, name: 'Samburu North', countyId: 25 },
    { id: 133, name: 'Samburu East', countyId: 25 }, { id: 134, name: 'Kwanza', countyId: 26 },
    { id: 135, name: 'Endebess', countyId: 26 }, { id: 136, name: 'Saboti', countyId: 26 },
    { id: 137, name: 'Kiminini', countyId: 26 }, { id: 138, name: 'Cherangany', countyId: 26 },
    { id: 139, name: 'Soy', countyId: 27 }, { id: 140, name: 'Turbo', countyId: 27 },
    { id: 141, name: 'Moiben', countyId: 27 }, { id: 142, name: 'Ainabkoi', countyId: 27 },
    { id: 143, name: 'Kapseret', countyId: 27 }, { id: 144, name: 'Kesses', countyId: 27 },
    { id: 145, name: 'Marakwet East', countyId: 28 }, { id: 146, name: 'Marakwet West', countyId: 28 },
    { id: 147, name: 'Keiyo North', countyId: 28 }, { id: 148, name: 'Keiyo South', countyId: 28 },
    { id: 149, name: 'Tinderet', countyId: 29 }, { id: 150, name: 'Aldai', countyId: 29 },
    { id: 151, name: 'Nandi Hills', countyId: 29 }, { id: 152, name: 'Chesumei', countyId: 29 },
    { id: 153, name: 'Emgwen', countyId: 29 }, { id: 154, name: 'Mosop', countyId: 29 },
    { id: 155, name: 'Tiaty', countyId: 30 }, { id: 156, name: 'Baringo North', countyId: 30 },
    { id: 157, name: 'Baringo Central', countyId: 30 }, { id: 158, name: 'Baringo South', countyId: 30 },
    { id: 159, name: 'Mogotio', countyId: 30 }, { id: 160, name: 'Eldama Ravine', countyId: 30 },
    { id: 161, name: 'Laikipia West', countyId: 31 }, { id: 162, name: 'Laikipia East', countyId: 31 },
    { id: 163, name: 'Laikipia North', countyId: 31 },
    { id: 164, name: 'Molo', countyId: 32 }, { id: 165, name: 'Njoro', countyId: 32 },
    { id: 166, name: 'Naivasha', countyId: 32 }, { id: 167, name: 'Gilgil', countyId: 32 },
    { id: 168, name: 'Kuresoi South', countyId: 32 }, { id: 169, name: 'Kuresoi North', countyId: 32 },
    { id: 170, name: 'Subukia', countyId: 32 }, { id: 171, name: 'Rongai', countyId: 32 },
    { id: 172, name: 'Bahati', countyId: 32 }, { id: 173, name: 'Nakuru Town West', countyId: 32 },
    { id: 174, name: 'Nakuru Town East', countyId: 32 },
    { id: 175, name: 'Kilgoris', countyId: 33 }, { id: 176, name: 'Emurua Dikirr', countyId: 33 },
    { id: 177, name: 'Narok North', countyId: 33 }, { id: 178, name: 'Narok East', countyId: 33 },
    { id: 179, name: 'Narok South', countyId: 33 }, { id: 180, name: 'Narok West', countyId: 33 },
    { id: 181, name: 'Kajiado North', countyId: 34 }, { id: 182, name: 'Kajiado Central', countyId: 34 },
    { id: 183, name: 'Kajiado East', countyId: 34 }, { id: 184, name: 'Kajiado West', countyId: 34 },
    { id: 185, name: 'Kajiado South', countyId: 34 },
    { id: 186, name: 'Ainamoi', countyId: 35 }, { id: 187, name: 'Belgut', countyId: 35 },
    { id: 188, name: 'Sigowet/Soin', countyId: 35 }, { id: 189, name: 'Kipkelion East', countyId: 35 },
    { id: 190, name: 'Kipkelion West', countyId: 35 },
    { id: 191, name: 'Sotik', countyId: 36 }, { id: 192, name: 'Chepalungu', countyId: 36 },
    { id: 193, name: 'Bomet East', countyId: 36 }, { id: 194, name: 'Bomet Central', countyId: 36 },
    { id: 195, name: 'Konoin', countyId: 36 },
    { id: 196, name: 'Lugari', countyId: 37 }, { id: 197, name: 'Likuyani', countyId: 37 },
    { id: 198, name: 'Malava', countyId: 37 }, { id: 199, name: 'Lurambi', countyId: 37 },
    { id: 200, name: 'Navakholo', countyId: 37 }, { id: 201, name: 'Mumias West', countyId: 37 },
    { id: 202, name: 'Mumias East', countyId: 37 }, { id: 203, name: 'Matungu', countyId: 37 },
    { id: 204, name: 'Butere', countyId: 37 }, { id: 205, name: 'Khwisero', countyId: 37 },
    { id: 206, name: 'Shinyalu', countyId: 37 }, { id: 207, name: 'Ikolomani', countyId: 37 },
    { id: 208, name: 'Vihiga', countyId: 38 }, { id: 209, name: 'Sabatia', countyId: 38 },
    { id: 210, name: 'Hamisi', countyId: 38 }, { id: 211, name: 'Luanda', countyId: 38 },
    { id: 212, name: 'Emuhaya', countyId: 38 },
    { id: 213, name: 'Mt. Elgon', countyId: 39 }, { id: 214, name: 'Sirisia', countyId: 39 },
    { id: 215, name: 'Kabuchai', countyId: 39 }, { id: 216, name: 'Bumula', countyId: 39 },
    { id: 217, name: 'Kanduyi', countyId: 39 }, { id: 218, name: 'Webuye East', countyId: 39 },
    { id: 219, name: 'Webuye West', countyId: 39 }, { id: 220, name: 'Kimilili', countyId: 39 },
    { id: 221, name: 'Tongaren', countyId: 39 },
    { id: 222, name: 'Teso North', countyId: 40 }, { id: 223, name: 'Teso South', countyId: 40 },
    { id: 224, name: 'Nambale', countyId: 40 }, { id: 225, name: 'Matayos', countyId: 40 },
    { id: 226, name: 'Butula', countyId: 40 }, { id: 227, name: 'Funyula', countyId: 40 },
    { id: 228, name: 'Budalangi', countyId: 40 },
    { id: 229, name: 'Ugenya', countyId: 41 }, { id: 230, name: 'Ugunja', countyId: 41 },
    ...
    { id: 235, name: 'Kisumu East', countyId: 42 }, { id: 236, name: 'Kisumu West', countyId: 42 },
    { id: 237, name: 'Kisumu Central', countyId: 42 }, { id: 238, name: 'Seme', countyId: 42 },
    { id: 239, name: 'Nyando', countyId: 42 }, { id: 240, name: 'Muhoroni', countyId: 42 },
    { id: 241, name: 'Nyakach', countyId: 42 },
    { id: 242, name: 'Kasipul', countyId: 43 }, { id: 243, name: 'Kabondo Kasipul', countyId: 43 },
    { id: 244, name: 'Karachuonyo', countyId: 43 }, { id: 245, name: 'Rangwe', countyId: 43 },
    { id: 246, name: 'Homa Bay Town', countyId: 43 }, { id: 247, name: 'Ndhiwa', countyId: 43 },
    { id: 248, name: 'Mbita', countyId: 43 }, { id: 249, name: 'Suba', countyId: 43 },
    { id: 250, name: 'Rongo', countyId: 44 }, { id: 251, name: 'Awendo', countyId: 44 },
    { id: 252, name: 'Suna East', countyId: 44 }, { id: 253, name: 'Suna West', countyId: 44 },
    { id: 254, name: 'Uriri', countyId: 44 }, { id: 255, name: 'Nyatike', countyId: 44 },
    { id: 256, name: 'Kuria West', countyId: 44 }, { id: 257, name: 'Kuria East', countyId: 44 },
    { id: 258, name: 'Bonchari', countyId: 45 }, { id: 259, name: 'South Mugirango', countyId: 45 },
    { id: 260, name: 'Bomachoge Borabu', countyId: 45 }, { id: 261, name: 'Bobasi', countyId: 45 },
    { id: 262, name: 'Bomachoge Chache', countyId: 45 }, { id: 263, name: 'Nyaribari Masaba', countyId: 45 },
    { id: 264, name: 'Nyaribari Chache', countyId: 45 }, { id: 265, name: 'Kitutu Chache North', countyId: 45 },
    { id: 266, name: 'Kitutu Chache South', countyId: 45 },
    { id: 267, name: 'Kitutu Masaba', countyId: 46 }, { id: 268, name: 'West Mugirango', countyId: 46 },
    { id: 269, name: 'North Mugirango', countyId: 46 }, { id: 270, name: 'Borabu', countyId: 46 },
    { id: 271, name: 'Westlands', countyId: 47 }, { id: 272, name: 'Dagoretti North', countyId: 47 },
    { id: 273, name: 'Dagoretti South', countyId: 47 }, { id: 274, name: "Lang'ata", countyId: 47 },
    { id: 275, name: 'Kibra', countyId: 47 }, { id: 276, name: 'Roysambu', countyId: 47 },
    { id: 277, name: 'Kasarani', countyId: 47 }, { id: 278, name: 'Ruaraka', countyId: 47 },
    { id: 279, name: 'Embakasi South', countyId: 47 }, { id: 280, name: 'Embakasi North', countyId: 47 },
    { id: 281, name: 'Embakasi Central', countyId: 47 }, { id: 282, name: 'Embakasi East', countyId: 47 },
    { id: 283, name: 'Embakasi West', countyId: 47 }, { id: 284, name: 'Makadara', countyId: 47 },
    { id: 285, name: 'Kamukunji', countyId: 47 }, { id: 286, name: 'Starehe', countyId: 47 },
    { id: 287, name: 'Mathare', countyId: 47 }
  ]);
