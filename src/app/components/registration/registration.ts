      ...
      <div *ngIf="showSuccess" class="fixed inset-0 bg-black/90 backdrop-blur flex items-center justify-center z-50 p-4">
        <div class="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-10 max-w-md border-2 border-green-600">
          <div class="text-center">
            ...
            <p class="text-red-400 text-sm mb-6">⚠️ Write this down! Check your email for it too.</p>
            <button (click)="goToLogin()" class="px-8 py-4 bg-green-600 hover:bg-green-700 text-white font-bold rounded-xl text-lg">
              Continue to Login
            </button>
          </div>
      ...
      <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-gray-900 rounded-2xl p-10 border-2 border-white/20">
          <div class="space-y-6">
            ...
            <!-- Email -->
           <div>
            <label class="block text-white font-bold mb-2">Email Address</label>
            <input
              [(ngModel)]="form.email"
              type="email"
              [class]="'w-full px-5 py-4 bg-white/5 border-2 rounded-lg text-white focus:outline-none ' +
            ...
            <p *ngIf="errors.email" class="text-red-400 text-sm mt-2">{{errors.email}}</p>
          </div>
            ...
            <!-- Server error -->
            <p *ngIf="serverError" class="text-red-400 text-sm text-center">{{serverError}}</p>

            <button
              (click)="register()"
              [disabled]="loading"
              class="w-full py-5 bg-gradient-to-r from-red-700 via-black to-green-700 text-white font-bold text-xl rounded-lg hover:opacity-90 disabled:opacity-50">
              Register
            </button>
          </div>
        </div>
...
export class RegistrationComponent implements OnInit {
  ...
  // Full constituencies and wards arrays copied from original registration.ts
  constituencies = signal<any[]>([
  ...
  // Wards kept minimal here — same as original. Paste full wards array from original if needed.
  wards = signal<any>([
    // WARDS ARRAY (1450+ wards)
    ...
    // Busia - Budalangi
    { id: 1449, name: "Bunyala Central", constituencyId: 290 },
    { id: 1450, name: "Bunyala North", constituencyId: 290 },
    { id: 1451, name: "Bunyala West", constituencyId: 290 },
    { id: 1452, name: "Bunyala South", constituencyId: 290 },
    { id: 1453, name: "Ruambwa", constituencyId: 290 },
    { id: 1454, name: "Makhobola", constituencyId: 290 }
  ]);
